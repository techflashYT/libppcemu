...
extern void do_sync(struct _ppcemu_state *state, u32 inst);
extern void do_eieio(struct _ppcemu_state *state);
extern void do_tlbie(struct _ppcemu_state *state, uint rB);
extern void do_tlbsync(struct _ppcemu_state *state);
...
extern void do_fmul_common(struct _ppcemu_state *state, uint frD, uint frA, uint frC, uint Rc, uint width);
#define do_fmul(s, frD, frA, frC, Rc) do_fmul_common(s, frD, frA, frC, Rc, 8)
#define do_fmuls(s, frD, frA, frC, Rc) do_fmul_common(s, frD, frA, frC, Rc, 4)
...
extern void do_fres(struct _ppcemu_state *state, uint frD, uint frB, uint Rc);
...
extern void do_lswi(struct _ppcemu_state *state, uint rD, uint rA, uint NB);
...
extern void do_ps_merge01(struct _ppcemu_state *state, uint frD, uint frA, uint frB, uint Rc);
...
extern void do_ps_muls0(struct _ppcemu_state *state, uint frD, uint frA, uint frC, uint Rc);
extern void do_ps_muls1(struct _ppcemu_state *state, uint frD, uint frA, uint frC, uint Rc);
...
extern void do_ps_rsqrte(struct _ppcemu_state *state, uint frD, uint frB, uint Rc);
...
extern void do_ps_add(struct _ppcemu_state *state, uint frD, uint frA, uint frB, uint Rc);
extern void do_ps_nmsub(struct _ppcemu_state *state, uint frD, uint frA, uint frB, uint frC, uint Rc);
extern void do_ps_nmadd(struct _ppcemu_state *state, uint frD, uint frA, uint frB, uint frC, uint Rc);
