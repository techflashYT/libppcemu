...
static inline void _do_basic_store(struct _ppcemu_state *state, uint len, u32 ea, void *val) {
...
static inline void _do_basic_load(struct _ppcemu_state *state, uint len, u32 ea, void *val) {
	enum virt2phys_err err;
	u32 phys;
